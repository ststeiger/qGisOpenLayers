...
function loadPage(page)
{
    ...
    $.ajax({ url: '/Scripts/turnJS/turnjs4/samples/steve-jobs/pages/page' + page + '.html' }).
		done(function(pageHtml) {
		    $('.sj-book .p' + page).html(pageHtml
                .replace('samples/steve-jobs/', '/Scripts/turnJS/turnjs4/samples/steve-jobs/')
                );
		});
...
function addPage(page, book) {
	...
	if (!book.turn('hasPage', page)) {
	    ...
	    var element = $('<div />') //, { 'class': 'own-size', css: { width: 460, height: 582 } })
